...
public class OrderController {
    ...
    public ResponseEntity<List<UmicoPurchase>> purchase(@Valid @RequestBody PurchaseRequestDto request) {
        return ResponseEntity.ok(service.purchase(request));
    }

    @PostMapping("/reverse")
    public ResponseEntity<List<UmicoPurchase>> reverse(@Valid @RequestBody ReverseRequestDto request) {
